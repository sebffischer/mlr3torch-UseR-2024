...
:::{.columns}
::: {.column width="50%"}
* `mlr3torch` naturally supports multi-modal data and `lazy_tensor`s can be stored in `data.frame`s
* On the right, we have some medical data about patients, as well as x-ray images
